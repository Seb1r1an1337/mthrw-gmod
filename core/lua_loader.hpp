...
namespace lualoader {
        ...
        using _lua_getfield = void(__cdecl*)(lua_State* L, int idx, const char* k);
        inline _lua_getfield lua_getfield = nullptr;

        using _lua_pushnumber = void(__cdecl*)(lua_State* L, double n);
        inline _lua_pushnumber lua_pushnumber = nullptr;

        using _lua_type = int(__cdecl*)(lua_State* L, int idx);
        inline _lua_type lua_type = nullptr;
